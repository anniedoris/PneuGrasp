...
execfile('actuator_optimization/Actuator.py')
execfile('actuator_optimization/ExperimentManager.py')
execfile('actuator_optimization/actuator_defintion.py')
execfile('actuator_optimization/Sweep.py')
execfile('actuator_optimization/GridSearch.py')
execfile('actuator_optimization/Extractor.py')
...
Sweep = Sweep('alpha', math.radians(1.0), math.radians(15.0), 15)
# GridSearch = GridSearch([
#     {'parameter': 't', 'lb': 1.5, 'ub': 2.5, 'num': 5},
#     {'parameter': 'b_core', 'lb': 1.0, 'ub': 3.0, 'num': 3},
#     {'parameter': 'wa_core', 'lb': 3.0, 'ub': 6.0, 'num': 3},
#     {'parameter': 'r_core', 'lb': 0.0, 'ub': 2.0, 'num': 3}
# ])
    ...
    if ExperimentManager.run_before:
        ...
        try:
            ...
            if testing:
                ...
                print >> sys.__stdout__, '\tHere'
                ExperimentManager.geometry_generated = True

        except Exception as e:
            print >> sys.__stdout__, '\tHere2'
            print >> sys.__stdout__, 'This is the problem'
        ...
        print >> sys.__stdout__, ExperimentManager.geometry_generated
